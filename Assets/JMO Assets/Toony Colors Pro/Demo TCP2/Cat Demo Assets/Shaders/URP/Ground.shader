...
/* TCP_DATA u config(ver:"2.9.21";unity:"2022.3.30f1";tmplt:"SG2_Template_URP";features:list["ENABLE_FORWARD_PLUS","UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","RAMP_MAIN_OTHER","RAMP_SEPARATED","TEXTURE_BLENDING","BLEND_TEX2","BLEND_TEX1","TEXBLEND_HEIGHT","SHADOW_HSV","SHADOW_COLOR_MAIN_DIR","UNITY_2019_2","UNITY_2019_3","UNITY_2019_4","UNITY_2020_1","UNITY_2021_1","UNITY_2021_2","UNITY_2022_2","TEMPLATE_LWRP","ENABLE_DEPTH_NORMALS_PASS"];flags:list[];flags_extra:dict[];keywords:dict[RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0",BLEND_TEX2_CHNL="g",BLEND_TEX1_CHNL="r",RENDER_TYPE="Opaque"];shaderProperties:list[,,,,,,,,,,,,,sp(name:"Blending Source";imps:list[imp_vcolors(cc:4;chan:"RGBA";linear:False;guid:"3a3b700c-b063-4b08-b4ec-b72e57f660c9";op:Multiply;lbl:"Blending Source";gpu_inst:False;dots_inst:False;locked:False;impl_index:-1)];layers:list[];unlocked:list[];layer_blend:dict[];custom_blend:dict[];clones:dict[];isClone:False),,,sp(name:"Blending Height Contrast";imps:list[imp_constant(type:float;fprc:float;fv:5;f2v:(1, 1);f3v:(1, 1, 1);f4v:(1, 1, 1, 1);cv:RGBA(1, 1, 1, 1);guid:"5069cec7-c4a0-4159-b805-259057f29165";op:Multiply;lbl:"Blending Height Contrast";gpu_inst:False;dots_inst:False;locked:False;impl_index:-1)];layers:list[];unlocked:list[];layer_blend:dict[];custom_blend:dict[];clones:dict[];isClone:False)];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[];mark:False);matLayers:list[]) */
/* TCP_HASH 2e205889a351378e6e930d8b7c5074a3 */
